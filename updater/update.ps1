...
class Updater
{
    ...
    static [void] DownloadNewFiles()
    {
        try
        {
            ...
            Invoke-WebRequest -TimeoutSec 10 https://raw.githubusercontent.com/Jonathing/MCGradle-Scripts/master/wrappers/tasks/eclipse.bat -OutFile '.\eclipse.bat'
            Invoke-WebRequest -TimeoutSec 10 https://raw.githubusercontent.com/Jonathing/MCGradle-Scripts/master/wrappers/tasks/genEclipseRuns.bat -OutFile '.\genEclipseRuns.bat'
            Invoke-WebRequest -TimeoutSec 10 https://raw.githubusercontent.com/Jonathing/MCGradle-Scripts/master/wrappers/tasks/genIntellijRuns.bat -OutFile '.\genIntellijRuns.bat'
            Invoke-WebRequest -TimeoutSec 10 https://raw.githubusercontent.com/Jonathing/MCGradle-Scripts/master/wrappers/tasks/intellij.bat -OutFile '.\intellij.bat'
            Invoke-WebRequest -TimeoutSec 10 https://raw.githubusercontent.com/Jonathing/MCGradle-Scripts/master/user-only/.gitignore -OutFile '.\.gitignore'
        }
        catch
        {
